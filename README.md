# Fullstack Authentication Example with Next.js, NextAuth.js and Tailwind

Based on  [Offical Authentication Example with Next.js and NextAuth.js from Prisma](https://github.com/prisma/prisma-examples/tree/latest/typescript/rest-nextjs-api-routes-auth)
...
```
cd nextjs-typescript-tailwind-nextauth-startet
npm install 
or 
yarn install
```
